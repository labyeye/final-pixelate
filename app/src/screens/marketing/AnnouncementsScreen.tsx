...
const AnnouncementsScreen = () => {
  ...
  const { data: announcements = [], isLoading } = useQuery({
    ...
    queryFn: () => api.get('/announcement').then(r => r.data),
  });
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <EmptyState
              ...
              subtitle="Website announcement bar messages"
              action={{
      ...
      >
        <SafeAreaView style={styles.modal}>
          ...
          <View style={styles.modalContent}>
            ...
            />
            <Button
              label={addMutation.isPending ? 'ADDING...' : 'ADD ANNOUNCEMENT'}
              onPress={() => {
                if (!form.text.trim()) {
                  Alert.alert('Error', 'Text required');
                  return;
                }
