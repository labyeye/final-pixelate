...
const LeadsScreen = () => {
  ...
  const addMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      setShowAdd(false);
      setNewLead({ name: '', phone: '', project: '', status: 'not called' });
    },
      ...
      <View style={styles.container}>
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <EmptyState
              title="No Leads"
              subtitle="Add your first lead"
              action={{ label: '+ Add Lead', onPress: () => setShowAdd(true) }}
            />
          }
          renderItem={({ item }) => (
            <TouchableOpacity
              ...
              <Card style={styles.card} shadow="sm">
                <Row justify="space-between" align="flex-start">
                  <View style={styles.cardLeft}>
                    ...
                    {item.project ? (
                      <Text style={styles.leadProject}>{item.project}</Text>
                    ) : null}
                    {item.source ? (
        ...
        <SafeAreaView style={styles.modal}>
          ...
          <View style={styles.modalContent}>
            <Input
              label="NAME *"
              value={newLead.name}
              onChangeText={v => setNewLead(p => ({ ...p, name: v }))}
              placeholder="Lead name"
            />
            <Input
              label="PHONE"
              value={newLead.phone}
              onChangeText={v => setNewLead(p => ({ ...p, phone: v }))}
            ...
            <Input
              ...
              onChangeText={v => setNewLead(p => ({ ...p, project: v }))}
            ...
            <View style={styles.statusPicker}>
              {STATUS_OPTIONS.map(s => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.statusOption,
                    newLead.status === s && styles.statusOptionActive,
                  ]}
                ...
                >
                  <Text
                    style={[
                      ...
                      newLead.status === s && styles.statusOptionTextActive,
                    ]}
                  >
                    {s}
                  </Text>
