          ...
          <Row justify="space-between" align="center">
            ...
            <View>
              ...
              <Text
                style={[
                  styles.amountValue,
                  { color: balance > 0 ? Colors.destructive : Colors.success },
                ]}
              >
          ...
          <View style={styles.modalContent}>
            ...
            <View style={styles.modeRow}>
              {['Bank Transfer', 'UPI', 'Cash', 'Cheque', 'Card'].map(m => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.modeChip,
                    paymentMode === m && styles.modeChipActive,
                  ]}
                ...
                >
                  <Text
                    style={[
                      styles.modeChipText,
                      paymentMode === m && styles.modeChipTextActive,
                    ]}
                  >
                    {m}
                  </Text>
            ...
            <Button
              ...
              onPress={() => {
                ...
                paymentMutation.mutate({
                  paidAmount: paid + Number(paymentAmount),
                  paymentDate,
                  paymentMode,
                  status:
                    paid + Number(paymentAmount) >= total ? 'paid' : 'partial',
                });
              }}
