        ...
        <FlatList
          ...
          ListEmptyComponent={
            <EmptyState
              ...
              action={{ label: '+ Add EMI', onPress: () => setShowAdd(true) }}
            />
          }
          renderItem={({ item }) => (
            <Card
        ...
        <SafeAreaView style={styles.modal}>
          ...
          <View style={styles.modalContent}>
            <Input
              ...
              onChangeText={v => setForm(p => ({ ...p, lenderName: v }))}
            ...
            <Input
              ...
              onChangeText={v => setForm(p => ({ ...p, remainingMonths: v }))}
              keyboardType="numeric"
            />
            <Input
              label="DUE DATE"
            ...
            />
            <Button
              label={addMutation.isPending ? 'ADDING...' : 'ADD EMI'}
              onPress={() => {
                if (!form.lenderName.trim() || !form.emiAmount) {
                  Alert.alert('Error', 'Lender and EMI amount required');
                  return;
                }
                addMutation.mutate({
                  ...form,
