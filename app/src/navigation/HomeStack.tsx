...
const HomeStack = () => (
  <Stack.Navigator
    ...
    <Stack.Screen name="Dashboard" component={DashboardScreen} options={{ title: 'PIXELATE NEST' }} />
    <Stack.Screen name="Analytics" component={AnalyticsScreen} options={{ title: 'ANALYTICS' }} />
    <Stack.Screen name="Reports" component={ReportsScreen} options={{ title: 'REPORTS' }} />
    <Stack.Screen name="UserActivity" component={UserActivityScreen} options={{ title: 'USER ACTIVITY' }} />
