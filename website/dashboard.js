...
(function () {
  function initTagInput(wrap) {
    ...
    function addTag(val) {
      ...
      // Avoid duplicates
      var existing = Array.from(wrap.querySelectorAll('.tag-pill span')).map(function (s) {
      ...
      btn.addEventListener('click', function () { pill.remove(); });
...
/* ═══════════════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════════════ */
(function () {
  document.querySelectorAll('[data-color-palette]').forEach(function (container) {
    ...
    var fieldName = container.getAttribute('data-field-name') || 'color_palette';
    ...
    function updateAddBtn() {
      addBtn.disabled = list.querySelectorAll('.color-swatch-item').length >= MAX;
    }

    addBtn.addEventListener('click', function () { addSwatch(); });
...
(function () {
  ...
  if (draftBtn) {
    draftBtn.addEventListener('click', function () {
      ...
      if (valid) {
        console.log('Save as Draft — collect form data here and POST to /api/projects');
  ...
  if (publishBtn) {
    publishBtn.addEventListener('click', function () {
      ...
      if (valid) {
        console.log('Publish — collect form data here and POST to /api/projects');
  ...
  function showToast(msg, bg) {
    ...
    Object.assign(t.style, {
      ...
      background: bg || '#1a3c8f', color: '#fff',
