            ...
            <DialogFooter>
              ...
              >
                {saving ? (
                  ...
                  <>
                    <PlusCircle className="h-4 w-4" /> Create EMI Plan
                  </>
                )}
              </Button>
            </DialogFooter>
...
function EmiCard({ emi, onRefresh }: { emi: any; onRefresh: () => void }) {
  ...
  const progressPct =
    emi.totalMonths > 0 ? Math.round((paidCount / emi.totalMonths) * 100) : 0;
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    ...
                    <strong>&quot;{emi.itemName}&quot;</strong>? This cannot be
                    undone.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
      ...
      <CardContent className="pt-0 space-y-4">
        ...
        <div className="space-y-1.5">
          <div className="flex justify-between text-xs font-semibold text-muted-foreground">
            <span>
              {paidCount} of {emi.totalMonths} EMIs paid
            </span>
        ...
        {expanded && (
          <div className="border-t border-border pt-4">
            <p className="text-sm font-black mb-3 uppercase tracking-wide text-muted-foreground">
              EMI Schedule
            </p>
                ...
                <TableBody>
                  {schedule.map((s: any, idx: number) => (
                    <TableRow
                      key={idx}
                      className={
                        s.status === "paid" ? "opacity-60" : "hover:bg-muted/30"
                      }
                    >
                      ...
                      <TableCell className="text-sm text-muted-foreground">
                        {s.paidOn
                          ? new Date(s.paidOn).toLocaleDateString("en-IN", {
                              day: "2-digit",
                              month: "short",
                              year: "numeric",
                            })
          ...
          <CardContent className="pt-4 pb-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-0.5">
                  {stats.active} active · {stats.total - stats.active} done
                </p>
              </div>
