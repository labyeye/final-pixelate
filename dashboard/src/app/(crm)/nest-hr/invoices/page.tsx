...
export default function NestHRInvoicesPage() {
  const [invoices, setInvoices] = useState<NestHRInvoice[]>([]);
  ...
  const fetchInvoices = async () => {
    ...
    try {
      const url =
        statusFilter !== "all"
          ? `/api/nesthr-invoices?status=${statusFilter}`
          : `/api/nesthr-invoices`;
