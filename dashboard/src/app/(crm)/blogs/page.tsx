    ...
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <aside className="p-4 bg-muted rounded-md">
          ...
          {imagePreview ? (
            <img src={imagePreview} alt="preview" className="w-full mb-2" />
          ) : (
            <div className="mb-2 text-sm text-muted">No image</div>
          )}
      ...
      <div className="mt-8">
        ...
        <div className="mb-4">
          <button className="mr-2" onClick={publishLocalPosts}>
            Publish Local Posts to Server
          </button>
