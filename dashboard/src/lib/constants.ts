...
export const leadStatuses = ['not called', 'called', 'not interested', 'meeting booked', 'interested', 'call back later', 'converted', 'other'] as const;
...
export const clientStatuses = ['active', 'inactive', 'prospect', 'churned'] as const;
