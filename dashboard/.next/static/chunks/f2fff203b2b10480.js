  ...
  (e) => {
    ...
    function i() {
      let [e, i] = (0, s.useState)([]),
        ...
        [g, j] = (0, s.useState)([]);
      (0, s.useEffect)(() => {
        let e = localStorage.getItem("pn_posts");
        if (e)
          try {
            i(JSON.parse(e));
          } catch (e) {}
      ...
      let { user: N } = (0, a.useAuth)(),
        v = N?.role === "admin";
      function y(e) {
        localStorage.setItem("pn_posts", JSON.stringify(e));
      }
      async function w() {
        if (!o) return alert("title required");
        let t = {
            id: Date.now(),
            title: o,
            category: n,
      ...
      async function S() {
        let t = localStorage.getItem("pn_posts");
        if (!t) return alert("No local posts found");
        let s = [];
        try {
          s = JSON.parse(t);
        } catch (e) {
        ...
        if (!s.length) return alert("No local posts to publish");
        let a =
            "localhost" === window.location.hostname ||
            "127.0.0.1" === window.location.hostname
              ? "https://backend.pixelatenest.com"
        ...
        (i(l),
          y(l),
          alert(
            "Publish attempt finished. Check public site or API to confirm.",
          ));
      }
      async function C() {
        let t;
        if (!b) return alert("Paste JSON into the import box first");
        try {
          t = JSON.parse(b);
        } catch (e) {
            ...
            children: [
              ...
              (0, t.jsxs)("aside", {
                ...
                children: [
                  ...
                  (0, t.jsx)("div", {
                    className: "font-bold",
                    children: o || "Title goes here",
                  }),
                  (0, t.jsx)("div", {
                    className: "text-sm text-muted mb-2",
                    children: n,
                  }),
                  (0, t.jsx)("div", { className: "text-sm", children: d }),
                ],
              }),
            ],
          }),
