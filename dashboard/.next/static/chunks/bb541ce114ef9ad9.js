(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    var s = e.i(91918),
      l = [
        ...
        let i = (0, s.createSlot)(`Primitive.${l}`),
          r = t.forwardRef((e, t) => {
            let { asChild: s, ...r } = e;
            return (
              "undefined" != typeof window &&
                (window[Symbol.for("radix-ui")] = !0),
              (0, a.jsx)(s ? i : l, { ...r, ref: t })
            );
          });
        return ((r.displayName = `Primitive.${l}`), { ...e, [l]: r });
      }, {}),
      i = t.forwardRef((e, t) =>
        (0, a.jsx)(l.label, {
          ...e,
    ...
    let n = (0, r.cva)(
      ...
      o = t.forwardRef(({ className: e, ...t }, s) =>
        (0, a.jsx)(i, { ref: s, className: (0, d.cn)(n(), e), ...t }),
      );
    ((o.displayName = i.displayName), e.s(["Label", () => o], 10204));
  },
  15288,
  (e) => {
    "use strict";
    ...
    let i = t.forwardRef(({ className: e, ...t }, l) =>
      (0, a.jsx)("div", {
        ref: l,
        className: (0, s.cn)("flex flex-col space-y-1.5 p-4", e),
        ...t,
      }),
    );
    i.displayName = "CardHeader";
    let r = t.forwardRef(({ className: e, ...t }, l) =>
      (0, a.jsx)("h3", {
        ref: l,
        className: (0, s.cn)(
    ...
    let d = t.forwardRef(({ className: e, ...t }, l) =>
      (0, a.jsx)("p", {
        ref: l,
    ...
    let n = t.forwardRef(({ className: e, ...t }, l) =>
      (0, a.jsx)("div", { ref: l, className: (0, s.cn)("p-4 pt-0", e), ...t }),
    );
    n.displayName = "CardContent";
    let o = t.forwardRef(({ className: e, ...t }, l) =>
      (0, a.jsx)("div", {
        ref: l,
        className: (0, s.cn)("flex items-center p-4 pt-0", e),
        ...t,
      }),
    );
  ...
  (e) => {
    ...
    var a = e.i(43476),
      t = e.i(71645),
      s = e.i(75157);
    let l = t.forwardRef(({ className: e, type: t, ...l }, i) =>
      (0, a.jsx)("input", {
        type: t,
        className: (0, s.cn)(
    ...
    ((l.displayName = "Input"), e.s(["Input", () => l]));
  },
  84774,
  (e) => {
    "use strict";
    ...
    ((o.displayName = "TableCell"),
      (t.forwardRef(({ className: e, ...t }, l) =>
        (0, a.jsx)("caption", {
          ref: l,
          className: (0, s.cn)("mt-4 text-sm text-muted-foreground", e),
          ...t,
        }),
  ...
  (e) => {
    ...
    o.displayName = s.Overlay.displayName;
    let c = t.forwardRef(({ className: e, children: t, ...r }, d) =>
      (0, a.jsxs)(n, {
        children: [
          (0, a.jsx)(o, {}),
          (0, a.jsxs)(s.Content, {
    ...
    c.displayName = s.Content.displayName;
    let m = ({ className: e, ...t }) =>
      (0, a.jsx)("div", {
        className: (0, i.cn)(
    ...
    let f = t.forwardRef(({ className: e, ...t }, l) =>
      (0, a.jsx)(s.Title, {
        ref: l,
        className: (0, i.cn)(
    ...
    let p = t.forwardRef(({ className: e, ...t }, l) =>
      (0, a.jsx)(s.Description, {
        ref: l,
  ...
  (e) => {
    "use strict";
    let a = (0, e.i(75254).default)("Plus", [
  ...
  (e) => {
    "use strict";
    let a = (0, e.i(75254).default)("Trash2", [
  ...
  (e) => {
    ...
    var a = e.i(43476),
      ...
      l = e.i(15288),
      i = e.i(7233);
    let r = (0, e.i(75254).default)("Pencil", [
      [
        "path",
        {
    ...
    var d = e.i(27612),
      ...
      u = e.i(8406);
    function f() {
      let [e, f] = (0, t.useState)([]),
        [p, x] = (0, t.useState)(!1),
        [h, g] = (0, t.useState)(!1),
        [b, j] = (0, t.useState)(!1),
        [y, v] = (0, t.useState)(null),
        { toast: N } = (0, u.useToast)(),
        w = {
          name: "",
          designation: "",
          phone: "",
      ...
      let C = async () => {
          try {
            x(!0);
            let e = await fetch("/api/about-team");
            if (!e.ok) throw Error("Failed to fetch team members");
            let a = await e.json();
            f(a);
          } catch (e) {
            N({
              title: "Error",
              description: e.message || "Failed to load team members",
              variant: "destructive",
            });
          } finally {
            x(!1);
        ...
        L = async (e) => {
          ...
          try {
            ...
            (N({
              title: "Success",
              description: `Team member ${y ? "updated" : "added"} successfully`,
            }),
              j(!1),
              T(w),
              v(null),
            ...
            N({
              title: "Error",
              description: e.message || "Failed to save team member",
              variant: "destructive",
            });
          } finally {
            x(!1);
        ...
        R = async (e) => {
          if (confirm("Are you sure you want to delete this team member?"))
            try {
              if (
                (x(!0),
                !(await fetch(`/api/about-team?id=${e}`, { method: "DELETE" }))
                  .ok)
              )
                  ...
                  children: [
                    (0, a.jsx)(o.DialogTrigger, {
                      ...
                      children: (0, a.jsxs)(s.Button, {
                        ...
                        children: [
                          (0, a.jsx)(i.Plus, { className: "mr-2 h-4 w-4" }),
                          "Add Team Member",
                        ],
                      }),
                    }),
            ...
            (0, a.jsx)(l.CardContent, {
              children:
                p && !e.length
                  ...
                  : (0, a.jsxs)(n.Table, {
                      children: [
                        (0, a.jsx)(n.TableHeader, {
                          children: (0, a.jsxs)(n.TableRow, {
                            children: [
                              (0, a.jsx)(n.TableHead, { children: "Order" }),
                              (0, a.jsx)(n.TableHead, { children: "Image" }),
                              (0, a.jsx)(n.TableHead, { children: "Name" }),
                              (0, a.jsx)(n.TableHead, {
                                children: "Designation",
                              }),
                              (0, a.jsx)(n.TableHead, { children: "Phone" }),
                              (0, a.jsx)(n.TableHead, {
