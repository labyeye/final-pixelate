module.exports = [
  ...
  (a, b, c) => {
    ...
    var d = a.r(72131),
      ...
      f = "undefined" != typeof process && process.env && !0,
      g = function (a) {
    ...
    function k() {
      ...
      (0, d.useEffect)(() => {
        l &&
          (async () => {
            try {
              let a = await fetch(`/api/quotations/${l}`);
              if (!a.ok) throw Error("Failed to fetch quotation");
              let b = await a.json();
              if ((n(b), b.clientId)) {
                let a = await fetch(`/api/clients/${b.clientId}`);
                a.ok && r(await a.json());
              }
              let c = await fetch("/api/settings");
              c.ok && p(await c.json());
            } catch (a) {
              console.error("Error loading quotation:", a);
            } finally {
              t(!1);
            }
          })();
      ...
      let {
          ...
          m.lineItems.reduce((a, b) => a + b.total, 0) +
          m.services.reduce((a, b) => a + b.total, 0)),
        {
          subtotal: a,
          taxAmount: m.lineItems.reduce(
            (a, b) => a + (b.unitPrice * b.qty * b.tax) / 100,
            0,
          ),
          grandTotal: a,
        }),
        y = new Date(m.date).toLocaleDateString("en-GB", {
          day: "2-digit",
          month: "long",
          year: "numeric",
        });
          ...
          (0, b.jsxs)("div", {
            ...
            children: [
              (0, b.jsxs)(f.Button, {
                onClick: () => {
                  let a = m._id || m.id || l;
                  k.push(`/quotations/create?edit=${a}`);
                },
                size: "lg",
                variant: "outline",
                className: "shadow-lg",
                children: [
                  (0, b.jsx)(j.Edit, { className: "mr-2 h-4 w-4" }),
                  "Edit",
                ],
              }),
              (0, b.jsxs)(f.Button, {
                ...
                className: "shadow-lg",
                children: [
                  (0, b.jsx)(h, { className: "mr-2 h-4 w-4" }),
                  "Print",
                ],
              }),
              (0, b.jsxs)(f.Button, {
                ...
                children: [
                  (0, b.jsx)(i, { className: "mr-2 h-4 w-4" }),
                  "Download PDF",
                ],
              }),
            ],
                        ...
                        (0, b.jsxs)("div", {
                          ...
                          children: [
                            ...
                            (0, b.jsx)("p", {
                              ...
                              children:
                                q?.businessName || q?.name || "Valued Client",
                            }),
                          ],
                        }),
                        (0, b.jsx)("p", {
                    ...
                    m.deliverables &&
                      ...
                      (0, b.jsxs)("section", {
                        ...
                        children: [
                          ...
                          (0, b.jsx)("ul", {
                            className: "jsx-b715cb8c1fa75266 space-y-2",
                            children: m.deliverables.map((a, c) =>
                              (0, b.jsxs)(
                                "li",
                                {
                                  className:
                                    ...
                                    (0, b.jsxs)("div", {
                                      ...
                                      children: [
                                        (0, b.jsx)("h4", {
                                          className:
                                            "jsx-b715cb8c1fa75266 font-semibold text-gray-900",
                                          children: a.moduleName,
                                        }),
                                        (0, b.jsx)("span", {
                                          className: `jsx-b715cb8c1fa75266 text-xs px-2 py-1 rounded-full ${"Completed" === a.status ? "bg-green-100 text-green-800" : "Ongoing" === a.status ? "bg-blue-100 text-blue-800" : "bg-gray-100 text-gray-800"}`,
                                          children: a.status,
                                        }),
                                      ],
                                    }),
                      ...
                      children: [
                        ...
                        (0, b.jsx)("div", {
                          ...
                          children: (0, b.jsx)("ol", {
                            ...
                            children: (m.customTerms && m.customTerms.length > 0
                              ? m.customTerms
                              : o?.terms || []
                            ).map((a, c) =>
                              (0, b.jsx)(
                      ...
                      children: (0, b.jsxs)("div", {
                        ...
                        children: [
                          ...
                          (0, b.jsx)("p", {
                            ...
                            children: o?.website || "www.pixelatenest.com",
                          }),
                        ],
                      }),
                    }),
...
//# sourceMappingURL=_7b008fbf._.js.map
