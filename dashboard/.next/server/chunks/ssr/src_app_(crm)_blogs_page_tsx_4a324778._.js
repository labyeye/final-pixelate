  ...
  (a) => {
    ...
    function f() {
      let [a, f] = (0, c.useState)([]),
        ...
        [s, t] = (0, c.useState)([]);
      (0, c.useEffect)(() => {
        let a = localStorage.getItem("pn_posts");
        if (a)
          try {
            f(JSON.parse(a));
          } catch (a) {}
      ...
      let { user: u } = (0, d.useAuth)(),
        v = u?.role === "admin";
      function w(a) {
        localStorage.setItem("pn_posts", JSON.stringify(a));
      }
      async function x() {
        if (!g) return alert("title required");
        let b = {
            id: Date.now(),
            title: g,
            category: i,
      ...
      async function y() {
        let b = localStorage.getItem("pn_posts");
        if (!b) return alert("No local posts found");
        let c = [];
        try {
          c = JSON.parse(b);
        } catch (a) {
        ...
        if (!c.length) return alert("No local posts to publish");
        let d =
            "localhost" === window.location.hostname ||
            "127.0.0.1" === window.location.hostname
              ? "https://backend.pixelatenest.com"
      ...
      async function z() {
        let b;
        if (!q) return alert("Paste JSON into the import box first");
        try {
          b = JSON.parse(q);
        } catch (a) {
            ...
            children: [
                  ...
                  (0, b.jsxs)("div", {
                    ...
                    children: [
                      ...
                      (0, b.jsx)("input", {
                        type: "file",
                        onChange: function (a) {
                          let b = a.target.files && a.target.files[0];
                          if (!b) return;
                          let c = new FileReader();
                          ((c.onload = () => p(String(c.result))),
                            c.readAsDataURL(b));
                        },
                        className: "p-3 rounded-md bg-background border",
                      }),
              ...
              (0, b.jsxs)("aside", {
                ...
                children: [
                  ...
                  (0, b.jsx)("div", {
                    className: "font-bold",
                    children: g || "Title goes here",
                  }),
                  (0, b.jsx)("div", {
                    className: "text-sm text-muted mb-2",
                    children: i,
                  }),
                  (0, b.jsx)("div", { className: "text-sm", children: k }),
                ],
              }),
            ],
          }),
