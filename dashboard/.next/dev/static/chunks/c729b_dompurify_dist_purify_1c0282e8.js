(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (__turbopack_context__, module, exports) => {
    /*! @license DOMPurify 2.5.8 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/2.5.8/LICENSE */ (function (
      global,
      factory,
    ) {
      ...
      /* Add properties to a lookup table */ function addToSet(
        set,
        array,
        transformCaseFunc,
      ) {
      ...
      function createDOMPurify() {
        ...
        var DocumentFragment = window1.DocumentFragment,
          HTMLTemplateElement = window1.HTMLTemplateElement,
          Node = window1.Node,
          Element = window1.Element,
          NodeFilter = window1.NodeFilter,
          _window$NamedNodeMap = window1.NamedNodeMap,
          NamedNodeMap =
            _window$NamedNodeMap === void 0
              ? window1.NamedNodeMap || window1.MozNamedAttrMap
              : _window$NamedNodeMap,
          HTMLFormElement = window1.HTMLFormElement,
          DOMParser = window1.DOMParser,
          trustedTypes = window1.trustedTypes;
        ...
        /* Explicitly forbidden tags (overrides ALLOWED_TAGS/ADD_TAGS) */ var FORBID_TAGS =
          null;
        /* Explicitly forbidden attributes (overrides ALLOWED_ATTR/ADD_ATTR) */ var FORBID_ATTR =
          null;
        ...
        /* Allow usage of profiles like html, svg and mathMl */ var USE_PROFILES =
          {};
        /* Tags to ignore content of when KEEP_CONTENT is true */ var FORBID_CONTENTS =
          null;
        ...
        /* Attributes safe for values like "javascript:" */ var URI_SAFE_ATTRIBUTES =
          null;
        ...
        /* Ideally, do not touch anything below this line */ /* ______________________________________________ */ var formElement =
        ...
        var _parseConfig = function _parseConfig(cfg) {
          ...
          /* Shield configuration object from tampering */ if (
            !cfg ||
            _typeof(cfg) !== "object"
          ) {
            cfg = {};
          }
          /* Shield configuration object from prototype pollution */ cfg =
            clone(cfg);
          ...
          transformCaseFunc =
            PARSER_MEDIA_TYPE === "application/xhtml+xml"
              ? stringToString
              : stringToLowerCase;
          /* Set configuration parameters */ ALLOWED_TAGS =
            "ALLOWED_TAGS" in cfg
          ...
          /* Add tbody to ALLOWED_TAGS in case tables are permitted, see #286, #365 */ if (
            ALLOWED_TAGS.table
          ) {
         ...
         */ var _initDocument = function _initDocument(dirty) {
          ...
          if (FORCE_BODY) {
            ...
            /* If FORCE_BODY isn't used, leading whitespace needs to be preserved manually */ var matches =
              stringMatch(dirty, /^[\r\n\t ]+/);
         ...
         */ var _sanitizeElements = function _sanitizeElements(currentNode) {
          var content;
          /* Execute a hook if present */ _executeHook(
          ...
          /* Check if tagname contains Unicode */ if (
            regExpTest(/[\u0080-\uFFFF]/, currentNode.nodeName)
          ) {
            _forceRemove(currentNode);
            return true;
          }
          /* Now let's check the element's type and name */ var tagName =
          ...
          /* Detect mXSS attempts abusing namespace confusion */ if (
          ...
          /* Mitigate a problem with templates inside select */ if (
            tagName === "select" &&
          ...
          /* Remove any ocurrence of processing instructions */ if (
          ...
          /* Remove element if anything forbids its presence */ if (
            ...
            /* Check if we have a custom element to handle */ if (
              !FORBID_TAGS[tagName] &&
          ...
          /* Check whether element has a valid namespace */ if (
          ...
          /* Make sure that older browsers don't get fallback-tag mXSS */ if (
            (tagName === "noscript" ||
              tagName === "noembed" ||
              tagName === "noframes") &&
          ...
          /* Sanitize element content to be template-safe */ if (
            ...
            /* Get the element's text content */ content =
        ...
        var _isValidAttribute = function _isValidAttribute(
          ...
          /* Make sure attribute cannot clobber */ if (
            SANITIZE_DOM &&
         ...
         */ var _sanitizeAttributes = function _sanitizeAttributes(
          ...
          l = attributes.length;
          /* Go backwards over all attributes; safely remove bad ones */ while (
            l--
          ) {
            attr = attributes[l];
            var _attr = attr,
            ...
            /* Did the hooks approve of the attribute? */ if (
            ...
            /* Is `value` valid for this attribute? */ var lcTag =
              transformCaseFunc(currentNode.nodeName);
            ...
            /* Work around a security issue with comments inside attributes */ if (
              SAFE_FOR_XML &&
            ...
            /* Handle attributes that require Trusted Types */ if (
              trustedTypesPolicy &&
              _typeof(trustedTypes) === "object" &&
            ...
            /* Handle invalid data-* attribute set by try-catching it */ try {
              if (namespaceURI) {
                ...
                /* Fallback to setAttribute() for browser-unrecognized namespaces e.g. "x-schema". */ currentNode.setAttribute(
                  name,
                  value,
                );
              }
        ...
        the user has requested a DOM object rather than a string */ IS_EMPTY_INPUT =
            !dirty;
          if (IS_EMPTY_INPUT) {
            dirty = "<!-->";
          }
          /* Stringify, in case dirty is an object */ if (
            typeof dirty !== "string" &&
            !_isNode(dirty)
          ) {
          ...
          /* Check we can run. Otherwise fall back or ignore */ if (
            !DOMPurify.isSupported
          ) {
            if (
          ...
          /* Check if dirty is correctly typed for IN_PLACE */ if (
            typeof dirty === "string"
          ) {
            IN_PLACE = false;
          }
          if (IN_PLACE) {
            /* Do some early pre-sanitization to avoid unsafe root nodes */ if (
              dirty.nodeName
            ) {
           ...
           elements being stripped by the parser */ body =
              _initDocument("<!---->");
            ...
            /* Exit directly if we have nothing to do */ if (
              !RETURN_DOM &&
              !SAFE_FOR_TEMPLATES &&
            ...
            /* Initialize the document to work on */ body =
              _initDocument(dirty);
            /* Check we have a DOM node from the data */ if (!body) {
              return RETURN_DOM ? null : RETURN_TRUSTED_TYPE ? emptyHTML : "";
            }
          }
          /* Remove first element node (ours) if FORCE_BODY is set */ if (
            body &&
            FORCE_BODY
          ) {
            _forceRemove(body.firstChild);
          }
          /* Get node iterator */ var nodeIterator = _createIterator(
            IN_PLACE ? dirty : body,
          );
          /* Now start iterating over the created document */ while (
            (currentNode = nodeIterator.nextNode())
          ) {
            /* Fix IE's strange behavior with manipulated textNodes #89 */ if (
              currentNode.nodeType === 3 &&
              currentNode === oldNode
            ) {
              continue;
            ...
            /* Shadow DOM detected, sanitize it */ if (
...
//# sourceMappingURL=c729b_dompurify_dist_purify_1c0282e8.js.map
