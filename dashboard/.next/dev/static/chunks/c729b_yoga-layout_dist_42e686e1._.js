(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  "[project]/Desktop/Projects/final-pixelate/dashboard/node_modules/yoga-layout/dist/binaries/yoga-wasm-base64-esm.js [app-client] (ecmascript)",
    ...
    var loadYoga = (() => {
      ...
      return function (loadYoga) {
        ...
        function Ua(a, b) {
          ...
          !!b.U !== !!b.T &&
            Ta("Both smartPtrType and smartPtr must be specified");
          b.count = {
            value: 1,
          };
          return T(
        ...
        function W(a, b, c = {}) {
          ...
          var d = b.name;
          a ||
            L('type "' + d + '" must have a positive integer typeid pointer');
          ...
          delete Ya[a];
          U.hasOwnProperty(a) &&
            ((b = U[a]), delete U[a], b.forEach((e) => e()));
        }
        function $a(a) {
        ...
        function ab(a, b, c) {
          if (void 0 === a[b].S) {
            var d = a[b];
            a[b] = function () {
              a[b].S.hasOwnProperty(arguments.length) ||
                L(
                  "Function '" +
                    c +
        ...
        function bb(a, b) {
          h.hasOwnProperty(a)
            ? (L("Cannot register public name '" + a + "' twice"),
              ab(h, a, a),
        ...
        function eb(a, b) {
          ...
          b.M.O ||
            L("Cannot pass deleted object as a pointer of type " + this.name);
        ...
        function gb(a, b) {
          ...
          if (this.da)
            switch (
              (void 0 === b.M.T &&
                L("Passing raw pointer to smart pointer is illegal"),
              this.Ba)
            ) {
              case 0:
                b.M.U === this
        ...
        function Y(a, b, c, d) {
          ...
          void 0 !== b.R
            ? (this.toWireType = gb)
            : ((this.toWireType = d ? eb : hb), (this.V = null));
        }
        function ib(a, b) {
        ...
        function jb(a, b) {
          ...
          return function () {
            ...
            if (a.includes("j")) {
              var d = h["dynCall_" + a];
              d =
                c && c.length ? d.apply(null, [b].concat(c)) : d.call(null, b);
        ...
        function Z(a, b) {
          ...
          "function" != typeof c &&
            L("unknown function pointer with signature " + a + ": " + b);
          return c;
        }
        var mb = void 0;
        function nb(a, b) {
          function c(f) {
            e[f] ||
              R[f] ||
              (Ya[f] ? Ya[f].forEach(c) : (d.push(f), (e[f] = !0)));
          }
          var d = [],
            e = {};
          b.forEach(c);
          ...
          Jb = {
            ...
            q: function (a, b, c) {
              ...
              f.__construct = function () {
                ...
                l = Ia(e, l);
                Q.hasOwnProperty(l)
                  ? L("Tried to register registered instance: " + l)
                  : (Q[l] = this);
              };
              f.__destruct = function () {
                ...
                Q.hasOwnProperty(l)
                  ? delete Q[l]
                  : L("Tried to unregister unregistered instance: " + l);
              };
            ...
            a: function (a, b, c, d, e, f, g, k) {
              ...
              V([], [a], function (l) {
                ...
                var r = l.N.X,
                  u = r[b];
                void 0 === u ||
                (void 0 === u.S && u.className !== l.name && u.Z === c - 2)
                  ? ((n.Z = c - 2), (n.className = l.name), (r[b] = n))
                  : (ab(r, b, p), (r[b].S[c - 2] = n));
                V([], m, function (t) {
                  t = ob(p, t, l, f, g);
                  void 0 === r[b].S
                    ? ((t.Z = c - 2), (r[b] = t))
              ...
              W(a, {
                ...
                toWireType: function (d, e) {
                  ...
                  g ||
                    ...
                    L("Cannot pass non-string to std::string");
                  if (c && g) {
                    var k = 0;
            ...
            i: function (a, b, c) {
              ...
              if (2 === b) {
                ...
                4 === b &&
                  ((d = wb), (e = xb), (f = yb), (g = () => E), (k = 2));
              W(a, {
                name: c,
                fromWireType: function (m) {
                  for (
                    var l = E[m >> 2], n = g(), p, r = m + 4, u = 0;
                    u <= l;
                    ++u
                  ) {
                    var t = m + 4 + u * b;
                ...
                toWireType: function (m, l) {
                  "string" != typeof l &&
                    L("Cannot pass non-string to C++ string type " + c);
                  var n = f(l),
                    p = Ib(4 + n + b);
                  E[p >> 2] = n >> k;
                  e(l, p + 4, n + b);
            ...
            m: function (a, b) {
              ...
              e = Cb((g, k, m, l) => {
                for (var n = 0, p = 0; p < a - 1; ++p)
                  ((f[p] = c[p + 1].readValueFromPointer(l + n)),
        ...
        (function () {
          function a(e) {
            ...
            0 == F &&
              (null !== ta && (clearInterval(ta), (ta = null)),
              G && ((e = G), (G = null), e()));
          }
          function b(e) {
            a(e.instance);
        ...
        h.__embind_initialize_bindings = function () {
          return (h.__embind_initialize_bindings = h.asm.H).apply(
            null,
            arguments,
          );
        };
  ...
  (__turbopack_context__) => {
    ...
    let Errata = /*#__PURE__*/ (function (Errata) {
      ...
      Errata[(Errata["AbsolutePercentAgainstInnerSize"] = 4)] =
      ...
      for (const fnName of [
        ...
        const methods = {
          [__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$node_modules$2f$yoga$2d$layout$2f$dist$2f$src$2f$generated$2f$YGEnums$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
            "Unit"
          ].Point]: lib.Node.prototype[fnName],
          [__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$node_modules$2f$yoga$2d$layout$2f$dist$2f$src$2f$generated$2f$YGEnums$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
            "Unit"
          ].Percent]: lib.Node.prototype[`${fnName}Percent`],
          [__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$node_modules$2f$yoga$2d$layout$2f$dist$2f$src$2f$generated$2f$YGEnums$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
            "Unit"
          ].Auto]: lib.Node.prototype[`${fnName}Auto`],
        };
  ...
  (__turbopack_context__) => {
    ...
    var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$node_modules$2f$yoga$2d$layout$2f$dist$2f$src$2f$wrapAssembly$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ =
      __turbopack_context__.i(
        "[project]/Desktop/Projects/final-pixelate/dashboard/node_modules/yoga-layout/dist/src/wrapAssembly.js [app-client] (ecmascript)",
      );
    var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$node_modules$2f$yoga$2d$layout$2f$dist$2f$src$2f$generated$2f$YGEnums$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ =
    ...
    async function loadYoga() {
      ...
      __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$node_modules$2f$yoga$2d$layout$2f$dist$2f$src$2f$wrapAssembly$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
        ...
        await (0,
        __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$node_modules$2f$yoga$2d$layout$2f$dist$2f$binaries$2f$yoga$2d$wasm$2d$base64$2d$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
          "default"
        ])(),
      );
    }
