(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (__turbopack_context__) => {
            ...
            _defineProperty(
              _defineProperty(
                _defineProperty(
                  _defineProperty(
                    _defineProperty(
                      _defineProperty(_defineProperty(_ht, m, k), e, D),
                      y,
                      T,
                    ),
                    p,
    ...
    var modernMatches = [
      ...
      [
        DUO,
        _wrapRegExp(/path opacity="([^"]*)".*d="([^"]*)"/, {
          d2: 2,
        }),
      ],
      [
        MONO,
        _wrapRegExp(/path fill="currentColor".*d="([^"]+)"/, {
          d1: 1,
        }),
      ],
    ];
    ...
    var legacyMatches = [
      ...
      [
        DUO,
        _wrapRegExp(/path class="([^"]*secondary[^"]*)".*d="([^"]+)"/, {
          attr2: 1,
          d2: 2,
        }),
      ],
      ...
      [
        DUO,
        _wrapRegExp(/path d="([^"]+)".*class="([^"]*secondary[^"]*)"/, {
          d2: 1,
          attr2: 2,
        }),
      ],
...
//# sourceMappingURL=c729b_%40fortawesome_fontawesome-svg-core_index_mjs_73dc836d._.js.map
