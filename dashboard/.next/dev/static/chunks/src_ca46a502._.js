...
"[project]/src/app/(crm)/about-us-team/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AboutUsTeamPage() {
    ...
    const handleDelete = async (id)=>{
        ...
        try {
            setLoading(true);
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$fetch$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiFetch"])(`/api/about-team?id=${id}`, {
                method: "DELETE"
            });
...
//# sourceMappingURL=src_ca46a502._.js.map