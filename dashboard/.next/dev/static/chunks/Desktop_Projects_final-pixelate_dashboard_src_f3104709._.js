                    ...
                    try {
                        ...
                        setStaffUsers(data.map({
                            "StaffPermissions.useEffect": (u)=>({
                                    ...u,
                                    allowedPages: u.allowedPages?.length ? u.allowedPages : __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$nav$2d$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["defaultStaffAllowed"]
                                })
                        }["StaffPermissions.useEffect"]));
                    } catch  {
                        toast({
...
_s(StaffPermissions, "gpmAa/il7fYwjxLi2sQMP4tphXI=", false, function() {
    return [
