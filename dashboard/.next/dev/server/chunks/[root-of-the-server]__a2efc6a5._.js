...
"[project]/Desktop/Projects/final-pixelate/dashboard/src/app/api/payments/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        console.log("PAYMENT_DEBUG: Incoming request", {
            invoiceId,
            amount
        });
        if (!invoiceId || !amount) {
        ...
        const invoice = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["findById"]("invoices", invoiceId);
        if (!invoice) {
        ...
        console.log("PAYMENT_DEBUG: Success", {
            invoiceId,
            newStatus,
            newPaid
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a2efc6a5._.js.map