module.exports = [
  ...
  "[project]/src/lib/social-media-planner.ts [app-route] (ecmascript)",
  (__turbopack_context__) => {
    "use strict";
  ...
  "[project]/src/app/api/cron/process-scheduled-posts/route.ts [app-route] (ecmascript)",
  (__turbopack_context__) => {
    "use strict";
    ...
    var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$social$2d$media$2d$planner$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ =
      __turbopack_context__.i(
        "[project]/src/lib/social-media-planner.ts [app-route] (ecmascript)",
      );
    var __TURBOPACK__imported__module__$5b$externals$5d2f$mongodb__$5b$external$5d$__$28$mongodb$2c$__cjs$29$__ =
    ...
    async function GET(request) {
      ...
      try {
        ...
        for (const post of pendingPosts) {
          const scheduledDt = (0,
          __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$social$2d$media$2d$planner$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__[
            "toDateTime"
          ...
          try {
            ...
            try {
              if (
                ...
                __TURBOPACK__imported__module__$5b$externals$5d2f$mongodb__$5b$external$5d$__$28$mongodb$2c$__cjs$29$__[
                  "ObjectId"
                ].isValid(accountId)
              ) {
                queryId =
            ...
            if (post.clientId) {
              try {
                ...
                if (client?.metaAccessToken) {
                  ...
                  console.log(
                    `[DEBUG] Using token from Client: ${post.clientId}`,
                  );
                }
              } catch (e) {
            ...
            if (post.platform === "Instagram") {
              ...
              if (!fbId)
                throw new Error("Facebook Page ID missing in settings");
              publishRes = await (0,
              __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$meta$2d$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__[
                "publishFacebookPost"
              ])(
