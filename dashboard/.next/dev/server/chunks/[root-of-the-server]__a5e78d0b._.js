...
async function GET(request, { params }) {
    ...
    try {
        ...
        const item = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["findById"]("expenses", id);
...
async function PUT(request, { params }) {
    ...
    try {
        ...
        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateById"]("expenses", id, {
            ...body,
            updatedAt: new Date()
        });
...
async function DELETE(request, { params }) {
    ...
    try {
        const { id } = await params;
        const ok = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deleteById"]("expenses", id);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a5e78d0b._.js.map