...
"[project]/src/app/api/upload-whatsapp-media/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    if (!accessToken || !phoneNumberId) {
        console.error("[WhatsApp Media] Missing META_ACCESS_TOKEN or WHATSAPP_PHONE_NUMBER_ID");
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    console.info(`[WhatsApp Media] Uploading: ${safeFilename}, size: ${(file.size / 1024).toFixed(1)} KB`);
    ...
    if (!waResponse.ok) {
        ...
        console.error(`[WhatsApp Media] Upload failed — HTTP ${waResponse.status}, ` + `code: ${errDetail?.code}, fbtrace_id: ${errDetail?.fbtrace_id}:`, JSON.stringify(waJson, null, 2));
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__65285359._.js.map