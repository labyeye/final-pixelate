...
"[project]/Desktop/Projects/final-pixelate/dashboard/src/app/api/whatsapp/messages/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const messages = await db.collection("whatsapp_messages").find(query).sort({
            timestamp: -1
        }).limit(100).toArray();
        // Get conversation threads
        const conversations = await db.collection("whatsapp_messages").aggregate([
            {
                $group: {
                    _id: "$phone",
                    phone: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6d6324da._.js.map