...
"[project]/src/app/api/social-media-accounts/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        const col = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCollection"]("socialMediaAccounts");
...
async function POST(request) {
    try {
        ...
        if (existing) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(existing, {
                status: 200,
                headers: CORS
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__aafc5913._.js.map