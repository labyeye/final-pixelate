...
async function deleteInventory(id) {
    ...
    const hex24 = typeof id === 'string' && /^[a-fA-F0-9]{24}$/.test(id);
    if (hex24) {
        // If deleting by ObjectId, try to restore inventory usage first (if this is an invoice)
...
async function findById(collectionName1, id) {
    const col = await getCollection(collectionName1);
...
async function updateById(collectionName1, id, update) {
    const col = await getCollection(collectionName1);
    ...
    if (hex24) {
        ...
        return findById(collectionName1, id);
    }
    ...
    if (collectionName1 === 'invoices') {
        ...
        if (byInvoiceNo) {
            ...
            return findById(collectionName1, String(byInvoiceNo._id));
        }
    }
    await col.updateOne({
        id: id
...
async function deleteById(collectionName1, id) {
    const col = await getCollection(collectionName1);
    const hex24 = typeof id === 'string' && /^[a-fA-F0-9]{24}$/.test(id);
    if (hex24) {
        const res = await col.deleteOne({
...
async function GET(request, { params }) {
    try {
        const item = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["findById"]('inventory', params.id);
...
async function PUT(request, { params }) {
    try {
        ...
        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateInventory"](params.id, body);
...
async function DELETE(request, { params }) {
    try {
        const ok = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deleteInventory"](params.id);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__54f0891b._.js.map