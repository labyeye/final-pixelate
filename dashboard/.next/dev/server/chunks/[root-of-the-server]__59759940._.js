module.exports = [
  ...
  "[project]/Desktop/Projects/final-pixelate/dashboard/src/app/api/projects/[id]/route.ts [app-route] (ecmascript)",
  (__turbopack_context__) => {
    "use strict";
          ...
          try {
            ...
            if (existing?._id) {
              ...
              if (updated.amount != null) {
                descriptionParts.push(
                  `💰 Amount: ₹${Number(updated.amount || 0).toLocaleString("en-IN")}`,
                );
              }
              if (updated.deliveryDate) {
                descriptionParts.push(
                  `📅 Delivery Date: ${updated.deliveryDate}`,
                );
              }
              if (serviceNames.length > 0) {
                descriptionParts.push(
                ...
                },
                {
                  $set: {
                    ...
                    metadata: {
                      ...
                      servicesCount: Array.isArray(updated.services)
              ...
              __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$journey$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__[
                "createProjectJourneyEvent"
              ])(db, projectId, updated, "updated");
            }
          } catch (journeyErr) {
            console.error(
              "Failed to sync project update to journey:",
              journeyErr,
            );
          }
        }
