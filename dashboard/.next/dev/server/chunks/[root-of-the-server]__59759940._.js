...
"[project]/Desktop/Projects/final-pixelate/dashboard/src/app/api/projects/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const item = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["findById"]('projects', id);
...
async function PUT(request, { params }) {
    try {
        ...
        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateById"]('projects', id, {
            ...body,
            updatedAt: new Date()
        });
        try {
            // update any invoice linked to this projectId
            const col = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCollection"]('invoices');
            ...
            if (body.status === 'COMPLETED' || updated && updated.status === 'COMPLETED') {
                ...
                if (!existing) {
                    await col.insertOne({
                        ...
                        amount: body.amount ?? updated?.amount ?? 0,
        ...
        if (updated && (updated.clientId || updated.client)) {
            try {
                ...
                if (existing?._id) {
                    ...
                    const serviceNames = Array.isArray(updated.services) ? updated.services.map((s)=>s?.name).filter((name)=>typeof name === 'string' && name.trim().length > 0) : [];
                    const descriptionParts = [
                    ...
                    await db.collection('journey_events').updateOne({
                        ...
                        $set: {
                            ...
                            description: descriptionParts.join('\n\n'),
                            status: 'Completed',
                            occurredAt: (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$journey$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseJourneyOccurredAt"])(updated.updatedAt, new Date()),
                            updatedAt: new Date(),
                            metadata: {
                                ...existing.metadata ?? {},
                                projectId,
                    ...
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$journey$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createProjectJourneyEvent"])(db, projectId, updated, 'updated');
                }
            } catch (journeyErr) {
...
async function DELETE(request, { params }) {
    try {
        const { id } = await params;
        const ok = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["softDeleteById"]('projects', id);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__59759940._.js.map