...
"[project]/src/app/api/nesthr-stats/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    try {
        const res = await fetch(`${NESTHR_URL}/api/admin/stats`, {
            headers: {
                Authorization: `Bearer ${NESTHR_TOKEN}`
            },
            next: {
                revalidate: 60
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8a859f11._.js.map