...
"[project]/src/app/api/fixed-expenses/[id]/payment/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request, { params }) {
    ...
    try {
        ...
        const fixedExpensesCol = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCollection"]("fixedExpenses");
        const expensesCol = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCollection"]("expenses");
        const fixedExpense = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["findById"]("fixedExpenses", id);
        if (!fixedExpense) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const payments = Array.isArray(fixedExpense.payments) ? fixedExpense.payments : [];
        const existingIdx = payments.findIndex((p)=>p.month === month);
        const existingExpenseId = existingIdx >= 0 ? payments[existingIdx].expenseId : null;
        ...
        if (status === "paid") {
            ...
            if (existingExpenseId && __TURBOPACK__imported__module__$5b$externals$5d2f$mongodb__$5b$external$5d$__$28$mongodb$2c$__cjs$29$__["ObjectId"].isValid(existingExpenseId)) {
                await expensesCol.updateOne({
                    _id: new __TURBOPACK__imported__module__$5b$externals$5d2f$mongodb__$5b$external$5d$__$28$mongodb$2c$__cjs$29$__["ObjectId"](existingExpenseId)
                }, {
                    $set: expenseDoc
                });
        ...
        } else if (existingExpenseId && __TURBOPACK__imported__module__$5b$externals$5d2f$mongodb__$5b$external$5d$__$28$mongodb$2c$__cjs$29$__["ObjectId"].isValid(existingExpenseId)) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["softDeleteById"]("expenses", existingExpenseId);
            expenseId = null;
        }
        const paymentEntry = {
            month,
        ...
        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["findById"]("fixedExpenses", id);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5cc29cca._.js.map