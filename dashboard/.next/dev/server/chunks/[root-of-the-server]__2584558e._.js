...
"[project]/Desktop/Projects/final-pixelate/dashboard/src/lib/meta-api.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/Desktop/Projects/final-pixelate/dashboard/src/app/api/social-media-metrics/sync/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$meta$2d$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/Projects/final-pixelate/dashboard/src/lib/meta-api.ts [app-route] (ecmascript)");
;
;
;
;
...
async function OPTIONS() {
    return new __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"](null, {
        headers: CORS
    });
}
async function POST(request) {
    try {
        ...
        const postsCol = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCollection"]("socialMediaPosts");
        let post;
        try {
            post = await postsCol.findOne({
                _id: new __TURBOPACK__imported__module__$5b$externals$5d2f$mongodb__$5b$external$5d$__$28$mongodb$2c$__cjs$29$__["ObjectId"](postId)
            });
        } catch  {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const postedUrl = post.postedLinks && post.postedLinks[accountId] || post.postedLink || undefined;
        if (!postedUrl) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "No post URL found for this account. Please save the posted link first (use 'Mark as Posted' in the Planner)."
            }, {
                status: 400,
                headers: CORS
            });
        }
        const accountsCol = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCollection"]("socialMediaAccounts");
        let account;
        try {
            account = await accountsCol.findOne({
                _id: new __TURBOPACK__imported__module__$5b$externals$5d2f$mongodb__$5b$external$5d$__$28$mongodb$2c$__cjs$29$__["ObjectId"](accountId)
            });
        } catch  {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        if (post.clientId) {
            try {
                ...
                const client = await clientsCol.findOne({
                    _id: new __TURBOPACK__imported__module__$5b$externals$5d2f$mongodb__$5b$external$5d$__$28$mongodb$2c$__cjs$29$__["ObjectId"](post.clientId)
                });
        ...
        if (!baseToken || !account.platformAccountId) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: !account.platformAccountId ? "No Page ID saved for this account. Go to the client's Social Tokens tab and enter the Facebook Page ID." : "No access token available. Go to the client's Social Tokens tab and add a System User Token.",
                needsConnect: true,
                accountId
            }, {
                status: 400,
        ...
        try {
            const pages = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$meta$2d$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getUserPages"])(baseToken);
            const matchedPage = pages.find((p)=>String(p.id) === String(account.platformAccountId));
        ...
        if (platform === "Facebook") {
            metrics = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$meta$2d$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fetchFbPostMetrics"])(postedUrl, account.platformAccountId, effectiveToken);
        } else if (platform === "Instagram") {
            if (!account.igAccountId) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    error: "No Instagram Business Account linked to this account. Make sure your Facebook Page has an Instagram Business Account connected."
                }, {
                    status: 400,
                    headers: CORS
                });
            }
            metrics = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$meta$2d$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fetchIgMediaMetrics"])(postedUrl, account.igAccountId, effectiveToken);
            if (metrics.skipped) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    skipped: true,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2584558e._.js.map