...
async function fetchFbPostMetrics(postUrl, pageId, pageAccessToken) {
    ...
    engUrl.searchParams.set("fields", "id,reactions.summary(true).limit(0),likes.summary(true).limit(0),comments.summary(true).limit(0),shares");
    ...
    if (engRes.ok) {
        ...
        fallbackUrl.searchParams.set("fields", "id,reactions.summary(true).limit(0),likes.summary(true).limit(0),comments.summary(true).limit(0),shares");
    ...
    try {
        ...
        if (insightRes.ok) {
            ...
            const metric = (insightData.data || []).find((d)=>d.name === "post_impressions_unique");
...
async function POST(request) {
    try {
        ...
        if (!account.accessToken || !account.platformAccountId) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "This account is not connected to Meta. Go to the Planner → Accounts section and click 'Connect to Meta'.",
                needsConnect: true,
                accountId
            }, {
                status: 400,
        ...
        if (platform === "Facebook") {
            metrics = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$meta$2d$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fetchFbPostMetrics"])(postedUrl, account.platformAccountId, account.accessToken);
            ...
            metrics = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$meta$2d$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fetchIgMediaMetrics"])(postedUrl, account.igAccountId, account.accessToken);
        } else {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
