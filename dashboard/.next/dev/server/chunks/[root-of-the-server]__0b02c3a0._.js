...
"[project]/src/app/api/trash/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PATCH(request, context) {
    ...
    try {
        ...
        const ok = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["restoreFromTrash"](id);
...
async function DELETE(request, context) {
    ...
    try {
        ...
        const ok = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["permanentlyDestroyTrashItem"](id);
        if (!ok) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Item not found in trash"
        }, {
            status: 404
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0b02c3a0._.js.map