...
"[project]/src/app/api/upload-expense-bill/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    ...
    try {
        ...
        const candidates = [
            (0, __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["join"])(process.cwd(), "..", "website", "assets", "expense-bills"),
            (0, __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["join"])(process.cwd(), "website", "assets", "expense-bills"),
            (0, __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["join"])(process.cwd(), "public", "uploads", "expense-bills"),
            (0, __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["join"])(__TURBOPACK__imported__module__$5b$externals$5d2f$os__$5b$external$5d$__$28$os$2c$__cjs$29$__["default"].tmpdir(), "pixelatenest", "expense-bills")
        ];
        let uploadDir = null;
        for (const cand of candidates){
            try {
                await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["mkdir"])(cand, {
                    recursive: true
                });
                uploadDir = cand;
                break;
        ...
        } else if (uploadDir.includes(__TURBOPACK__imported__module__$5b$externals$5d2f$os__$5b$external$5d$__$28$os$2c$__cjs$29$__["default"].tmpdir())) {
            url = `file://${filePath}`;
        } else {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__52c3b57f._.js.map