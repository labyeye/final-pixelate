...
async function GET(request) {
    try {
        const col = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCollection"]('enquiries');
...
async function PATCH(request) {
    try {
        ...
        if (!acknowledged) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'update failed'
        }, {
            status: 500,
            headers: CORS
...
async function DELETE(request) {
    try {
        ...
        if (!acknowledged || deletedCount === 0) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'delete failed'
        }, {
            status: 500,
            headers: CORS
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c45131a7._.js.map