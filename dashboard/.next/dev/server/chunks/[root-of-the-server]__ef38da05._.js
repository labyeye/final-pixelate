...
"[project]/Desktop/Projects/final-pixelate/dashboard/src/app/api/careers/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const jobs = await db.collection('careers').aggregate([
            {
                $lookup: {
                    from: 'applications',
                    localField: '_id',
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(jobs, {
            headers: corsHeaders
        });
    } catch (error) {
