...
"[project]/src/app/api/settings/sidebar/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    try {
        const users = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getUsers"]();
...
async function POST(request) {
    ...
    try {
        ...
        const col = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCollection"]("users");
        const update = {
        ...
        try {
            const { getDb } = await __turbopack_context__.A("[project]/src/lib/mongodb.ts [app-route] (ecmascript, async loader)");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__dc6699b8._.js.map