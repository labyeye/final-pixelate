...
function BrandGuidePage() {
    ...
    function handleFileChange(e) {
        ...
        reader.onload = async (ev)=>{
            ...
            setParseStep(3);
            try {
                const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$fetch$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiFetch"])("/api/parse-brand-guide-pdf", {
                    method: "POST",
                    headers: {
    ...
    async function handleDelete(guide) {
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$fetch$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiFetch"])(`/api/brand-guides/${id}`, {
                method: "DELETE"
            });
            toast({
                title: "Deleted",
