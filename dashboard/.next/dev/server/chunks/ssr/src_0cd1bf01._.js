...
function TasksPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const storedUserId = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : null;
    ...
    const updateTaskStatus = async (taskId, newStatus)=>{
        try {
            const url = userId ? `/api/tasks/${taskId}?userId=${encodeURIComponent(userId)}` : `/api/tasks/${taskId}`;
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$fetch$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiFetch"])(url, {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json"
...
function TaskColumn({ title, count, color, textColor = "text-muted-foreground", tasks, onStatusChange }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=src_0cd1bf01._.js.map