...
"[project]/Desktop/Projects/final-pixelate/dashboard/src/app/(crm)/client/calendar/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
        ...
        const fetchEvents = async ()=>{
            try {
                ...
                if (tasksRes.ok) {
                    ...
                    const clientTasks = Array.isArray(tasks) ? tasks.filter((t)=>t.clientId === user.clientId) : [];
                    allEvents = [
                        ...allEvents,
                        ...clientTasks.map((t)=>({
                                ...t,
