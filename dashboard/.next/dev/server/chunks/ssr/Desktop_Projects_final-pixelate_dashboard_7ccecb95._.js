  ...
  (__turbopack_context__) => {
    ...
    function LeadsPage() {
      ...
      async function handleImport() {
        ...
        const XLSX = await __turbopack_context__.A(
          "[project]/Desktop/Projects/final-pixelate/dashboard/node_modules/xlsx/xlsx.mjs [app-ssr] (ecmascript, async loader)",
        );
        ...
        const parsed = rows.map((r) => {
          ...
          if (staffName) {
            ...
            matched = team.find(
              (t) =>
                t.name &&
                String(t.name).toLowerCase() === staffName.toLowerCase(),
            );
            // contains
            if (!matched)
              matched = team.find(
        ...
        async function postBatch(batch, retries = 2) {
          const headers = {
        ...
        try {
          ...
          for (let i = 0; i < parsed.length; i += batchSize) {
            ...
            if (!result.ok) {
              ...
              setImportProgress((p) => ({
                current: Math.min(parsed.length, p.current + batch.length),
                total: parsed.length,
              }));
            }
          }
          ...
          if (failedItems.length) {
            ...
            setImportProgress({
              current: parsed.length - failedItems.length,
              total: parsed.length,
            });
            alert(
              `Imported ${parsed.length - failedItems.length} items to server. ${failedItems.length} items saved locally due to upload failures.`,
            );
          } else {
            ...
            try {
              ...
              console.warn("Failed to refresh after import", er);
            }
            setImportProgress({
                ...
                "div",
                {
                  ...
                  children: [
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__[
                      ...
                      {
                        className:
                          "w-full h-3 bg-muted rounded overflow-hidden",
                        children: /*#__PURE__*/ (0,
                        __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__[
                          "jsxDEV"
                        ])(
                          "div",
                          {
                            ...
                            className:
                              "h-3 bg-primary transition-all duration-500",
                            style: {
                              width:
...
//# sourceMappingURL=Desktop_Projects_final-pixelate_dashboard_7ccecb95._.js.map
