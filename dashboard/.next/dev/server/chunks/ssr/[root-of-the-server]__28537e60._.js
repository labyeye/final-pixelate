module.exports = [
  ...
  '[project]/Desktop/Projects/final-pixelate/dashboard/src/assets/images/Logo_White_Name_Large.png.mjs { IMAGE => "[project]/Desktop/Projects/final-pixelate/dashboard/src/assets/images/Logo_White_Name_Large.png (static in ecmascript, tag client)" } [app-ssr] (structured image object with data url, ecmascript)',
  (__turbopack_context__) => {
    "use strict";
    ...
    return __turbopack_context__.a(
      async (
        ...
        try {
          ...
          var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$assets$2f$images$2f$Logo_White_Name_Large$2e$png$2e$mjs__$7b$__IMAGE__$3d3e$__$225b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$assets$2f$images$2f$Logo_White_Name_Large$2e$png__$28$static__in__ecmascript$2c$__tag__client$2922$__$7d$__$5b$app$2d$ssr$5d$__$28$structured__image__object__with__data__url$2c$__ecmascript$29$__ =
            __turbopack_context__.i(
              '[project]/Desktop/Projects/final-pixelate/dashboard/src/assets/images/Logo_White_Name_Large.png.mjs { IMAGE => "[project]/Desktop/Projects/final-pixelate/dashboard/src/assets/images/Logo_White_Name_Large.png (static in ecmascript, tag client)" } [app-ssr] (structured image object with data url, ecmascript)',
            );
          ...
          function OnboardingPDF({ data }) {
            ...
            const projectType =
              data?.projectType ?? data?.purpose ?? data?.objective;
            const productType =
              data?.productType ??
            ...
            const outOfScope = normalizeList(
              data?.outOfScope ?? data?.exclusions,
            );
          ...
          function OnboardingPage() {
            ...
            const toClientIdValue = (value) => {
              ...
              if (typeof value === "object") {
                return (
                  String(value.$oid ?? value._id ?? value.id ?? "") || null
                );
              }
              return String(value);
            };
            const mapOnboardingToForm = (item) => ({
              ...
              date:
                toDateInputValue(item?.date) || toDateInputValue(new Date()),
            ...
            const saveAndGenerate = async () => {
              ...
              try {
                ...
                toast({
                  ...
                  description:
                    "Failed to save onboarding record. Please try again.",
                  variant: "destructive",
                });
              } finally {
                setLoading(false);
            ...
            const handleDeleteOnboarding = async (item) => {
              ...
              try {
                ...
                toast({
                  title: "Delete Failed",
                  description:
                    e?.message || "Failed to delete onboarding record.",
                  variant: "destructive",
                });
              } finally {
                setLoading(false);
                              ...
                              "div",
                              {
                                ...
                                children: [
                                  ...
                                  __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__[
                                    ...
                                    {
                                      className:
                                        "md:col-span-2 border-t pt-4 mt-2",
                                      children: (0,
                                      __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__[
                                        "jsxDEV"
                                      ])(
