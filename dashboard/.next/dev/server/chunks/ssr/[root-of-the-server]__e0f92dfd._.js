...
(()=>{
    const e = new Error("Cannot find module '@/components/quotations/quotation-print-layout'");
    ...
    const generateQuotationPdf = async (quote, clientData)=>{
        ...
        await new Promise((resolve)=>{
            doc.html(finalHtml, {
                ...
                // scale:1 forces 1:1 pixel ratio — without this, retina (2x) screens produce 4x the pixels → 100MB+ PDFs
                html2canvas: {
                    scale: 1,
                    useCORS: true,
                    logging: false
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e0f92dfd._.js.map