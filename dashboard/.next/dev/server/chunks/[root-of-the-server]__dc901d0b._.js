...
"[project]/Desktop/Projects/final-pixelate/dashboard/src/app/api/whatsapp-templates/sync/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    ...
    try {
        ...
        if (!res.ok) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: (json?.error?.message ?? "Meta API error") + " — Check WHATSAPP_BUSINESS_ACCOUNT_ID and token permissions."
            }, {
                status: 422
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__dc901d0b._.js.map