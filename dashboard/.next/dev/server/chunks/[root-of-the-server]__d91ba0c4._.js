...
async function createInventory(item) {
    ...
    const toInsert = {
        ...
        status: Number(item.quantityAvailable || 0) > 0 ? 'Available' : 'Out of Stock',
        createdAt: new Date(),
        updatedAt: new Date()
    };
...
async function adjustInventoryQuantities(items, direction) {
    ...
    for (const it of items){
        try {
            ...
            const status = next > 0 ? 'Available' : 'Out of Stock';
...
async function GET() {
    try {
        const col = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCollection"]('expenses');
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d91ba0c4._.js.map