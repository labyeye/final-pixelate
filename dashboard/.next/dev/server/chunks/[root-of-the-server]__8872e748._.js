...
"[project]/src/app/api/whatsapp/delivery-log/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    try {
        ...
        const col = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCollection"])("invoices");
        const query = {
            whatsapp_sent: true
        };
        ...
        const invoices = await col.find(query, {
            projection: {
                _id: 1,
                invoiceNumber: 1,
                clientName: 1,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8872e748._.js.map