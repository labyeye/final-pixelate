...
"[project]/Desktop/Projects/final-pixelate/dashboard/src/app/api/onboarding/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const col = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCollection"])("onboardings");
        let filter = {};
        if (clientIdParam) {
            try {
                filter = {
        ...
        const items = await col.find(filter).sort({
            createdAt: -1
        }).toArray();
...
async function POST(request) {
    try {
        ...
        const created = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createOnboarding"])(body);
        if (created?.clientId) {
            try {
                const db = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getDb"])();
                const onboardingId = String(created._id ?? created.id ?? "");
                const existing = onboardingId ? await db.collection("journey_events").findOne({
                    "metadata.onboardingId": onboardingId
                }) : null;
                if (!existing && onboardingId) {
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$journey$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createOnboardingJourneyEvent"])(db, onboardingId, created);
                }
            } catch (journeyErr) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__625ace1a._.js.map