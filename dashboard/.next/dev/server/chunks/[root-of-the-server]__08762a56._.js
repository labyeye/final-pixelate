...
async function GET(request, { params }) {
    try {
        ...
        const item = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["findById"]("clients", id);
...
async function PUT(request, { params }) {
    try {
        ...
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["findById"]("clients", id);
        const clientUpdate = {
            ...clientData
        };
        if (loginEmail) clientUpdate.loginEmail = loginEmail;
        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateById"]("clients", id, clientUpdate);
        if (loginEmail || loginPassword) {
            if (existing?.userId) {
                const userUpdate = {};
                if (loginEmail) userUpdate.email = loginEmail;
                if (loginPassword) userUpdate.password = loginPassword;
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateById"]("users", String(existing.userId), userUpdate);
                ...
                const createdUser = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createUser"](userPayload);
                const userId = String(createdUser._id ?? createdUser.id);
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateById"]("clients", id, {
                    userId,
                    loginEmail
                });
            }
...
async function DELETE(request, { params }) {
    try {
        ...
        if (existing?.userId) {
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deleteById"]("users", String(existing.userId));
            } catch (e) {}
        }
        const ok = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deleteById"]("clients", id);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok
        });
    } catch (e) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__08762a56._.js.map