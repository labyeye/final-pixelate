...
"[project]/src/app/api/onboarding/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    try {
        ...
        const col = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCollection"])("onboardings");
        let filter = {};
        if (clientIdParam) {
            try {
                filter = {
...
async function POST(request) {
    ...
    try {
        ...
        const created = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createOnboarding"])(body);
        if (created?.clientId) {
            try {
                const db = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getDb"])();
                ...
                if (!existing && onboardingId) {
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$journey$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createOnboardingJourneyEvent"])(db, onboardingId, created);
                }
            } catch (journeyErr) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0b93c5c1._.js.map