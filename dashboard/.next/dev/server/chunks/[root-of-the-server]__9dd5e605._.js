...
async function getStaffReport(startDate, endDate, staffMemberId) {
    const tasksCol = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCollection"]("tasks");
    const dateQuery = getDateQuery("createdAt", startDate, endDate);
    if (staffMemberId && staffMemberId !== "all") {
        let staffName = null;
        try {
            const member = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["findById"]("team-members", staffMemberId);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9dd5e605._.js.map