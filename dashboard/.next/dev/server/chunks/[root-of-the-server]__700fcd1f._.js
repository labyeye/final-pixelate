...
"[project]/Desktop/Projects/final-pixelate/dashboard/src/app/api/journey/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const events = await db.collection('journey_events').find(filter).sort({
            occurredAt: 1
        }).toArray();
...
async function POST(request) {
    try {
        ...
        const { clientId, clientName, projectId, projectName, type, title, description, performedBy, status, fileUrl, linkUrl, occurredAt, metadata } = body;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__700fcd1f._.js.map