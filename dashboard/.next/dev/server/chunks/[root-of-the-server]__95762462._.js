...
"[project]/src/app/api/social-media-metrics/sync/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        try {
            const pages = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$meta$2d$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getUserPages"])(baseToken);
        ...
        if (platform === "Facebook") {
            metrics = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$meta$2d$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fetchFbPostMetrics"])(postedUrl, account.platformAccountId, effectiveToken);
            ...
            metrics = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$meta$2d$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fetchIgMediaMetrics"])(postedUrl, account.igAccountId, effectiveToken);
            if (metrics.skipped) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    skipped: true,
