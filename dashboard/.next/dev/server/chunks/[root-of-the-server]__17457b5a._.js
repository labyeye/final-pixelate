module.exports = [
  ...
  "[project]/Desktop/Projects/final-pixelate/dashboard/src/app/api/work-gallery/[id]/route.ts [app-route] (ecmascript)",
  (__turbopack_context__) => {
    "use strict";
    ...
    async function DELETE(_request, { params }) {
      try {
        ...
        const { verifyToken } = await __turbopack_context__.A(
          "[project]/Desktop/Projects/final-pixelate/dashboard/src/lib/auth.ts [app-route] (ecmascript, async loader)",
        );
