module.exports = [
  ...
  "[project]/src/app/api/campaigns/route.ts [app-route] (ecmascript)",
  (__turbopack_context__) => {
    "use strict";
      ...
      try {
        ...
        const messagesByStatus = {
          ...
          read: messages.filter(
            (m) => m.deliveryStatus === "read" || m.status === "read",
          ).length,
        ...
        console.log(
          `[Campaign Insights] Messages by status:`,
          messagesByStatus,
        );
        console.log(
          `[Campaign Insights] Sample messages:`,
          messages.slice(0, 3),
        );
