...
"[project]/src/app/api/quotations/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const quote = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["findById"]("quotations", id);
        if (!quote) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Not found"
        }, {
            status: 404
        });
...
async function PUT(request, { params }) {
    try {
        ...
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["findById"]("quotations", id);
        const prevStatus = existing?.status ?? "DRAFT";
        const newStatus = body.status ?? prevStatus;
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateById"]("quotations", id, {
            ...body,
            updatedAt: new Date()
        });
        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["findById"]("quotations", id);
        if (updated && updated.clientId && prevStatus === "DRAFT" && newStatus !== "DRAFT") {
            try {
                ...
                if (!alreadyExists) {
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$journey$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createQuotationJourneyEvent"])(db, id, updated);
                }
            } catch (journeyErr) {
...
async function DELETE(request, { params }) {
    try {
        ...
        if (decoded.role !== "admin") return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Forbidden"
        }, {
            status: 403
        });
        ...
        const ok = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["softDeleteById"]("quotations", id);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a2c0caf5._.js.map