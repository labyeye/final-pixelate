module.exports = [
  ...
  "[project]/Desktop/Projects/final-pixelate/dashboard/src/app/api/user-activity/route.ts [app-route] (ecmascript)",
  (__turbopack_context__) => {
    "use strict";
    ...
    async function POST(req) {
      try {
        ...
        if (body.type === "page_view") {
          ...
          const ObjectId = __turbopack_context__.r(
            "[externals]/mongodb [external] (mongodb, cjs)",
          ).ObjectId;

          await db.collection("user_activity").updateOne(
            {
              _id: new (__turbopack_context__.r(
                "[externals]/mongodb [external] (mongodb, cjs)",
              ).ObjectId)(body.id),
            },
            {
