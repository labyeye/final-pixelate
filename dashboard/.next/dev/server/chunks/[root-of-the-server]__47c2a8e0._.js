...
"[project]/Desktop/Projects/final-pixelate/dashboard/src/app/api/reviews/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const col = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCollection"]('reviews');
        const filter = {};
        if (approved !== null && approved !== undefined) {
            filter.approved = approved === 'true';
        }
        const reviews = await col.find(filter).sort({
            createdAt: -1
        }).limit(limit).toArray();
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(reviews, {
            headers: CORS_HEADERS
        });
    } catch (e) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__47c2a8e0._.js.map