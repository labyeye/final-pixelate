module.exports = [
  ...
  "[project]/src/app/api/fb-ads-connection/route.ts [app-route] (ecmascript)",
  (__turbopack_context__) => {
    "use strict";
      ...
      await col.updateOne(
        ...
        },
        {
          $set: {
            ...
            selectedFormIds: Array.isArray(selectedFormIds)
              ? selectedFormIds
              : [],
            isActive: true,
            updatedAt: new Date(),
    ...
    async function PATCH(request) {
      ...
      if (Array.isArray(selectedFormIds))
        updates.selectedFormIds = selectedFormIds;
