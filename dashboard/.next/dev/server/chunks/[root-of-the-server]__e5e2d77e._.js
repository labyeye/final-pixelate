...
"[project]/src/app/api/whatsapp-templates/upload-media/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    const sessionUrl = `https://graph.facebook.com/${apiVersion}/${appId}/uploads` + `?file_name=${encodeURIComponent(fileName)}` + `&file_length=${fileLength}` + `&file_type=${encodeURIComponent(fileType)}`;
    let sessionRes;
    try {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e5e2d77e._.js.map