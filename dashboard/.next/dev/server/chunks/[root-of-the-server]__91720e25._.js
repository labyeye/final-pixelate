module.exports = [
  ...
  "[project]/Desktop/Projects/final-pixelate/dashboard/src/app/api/settings/sidebar/route.ts [app-route] (ecmascript)",
  (__turbopack_context__) => {
    "use strict";
      ...
      try {
        ...
        const staff = users
          ...
          .map((u) => ({
            ...
            pagePermissions:
              u.pagePermissions ||
              (u.allowedPages || []).reduce((acc, href) => {
                acc[href] = {
                  view: true,
                };
                return acc;
    ...
    async function POST(request) {
      try {
        ...
        try {
          const { getDb } = await __turbopack_context__.A(
            "[project]/Desktop/Projects/final-pixelate/dashboard/src/lib/mongodb.ts [app-route] (ecmascript, async loader)",
          );
