...
"[project]/Desktop/Projects/final-pixelate/dashboard/src/app/api/meta-leads/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    ...
    try {
        ...
        for (const form of forms){
            ...
            const leadsRes = await fetch(`https://graph.facebook.com/v19.0/${form.id}/leads?fields=id,field_data,created_time,campaign_name,campaign_id,ad_name,ad_id,adset_name,adset_id&access_token=${pageToken}`);
            ...
            for (const ml of metaLeads){
                ...
                const campaignName = ml.campaign_name || formName || "";
                const adName = ml.ad_name || "";
                const fbLeadId = ml.id || "";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__022163d3._.js.map