...
"[project]/Desktop/Projects/final-pixelate/dashboard/src/app/api/payments/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function DELETE(req, { params }) {
    try {
        ...
        const invoicesCol = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCollection"])("invoices");
        // Find the invoice
        let invoice = await invoicesCol.findOne({
            _id: invoiceId
        });
        if (!invoice) {
            try {
                invoice = await invoicesCol.findOne({
                    _id: new __TURBOPACK__imported__module__$5b$externals$5d2f$mongodb__$5b$external$5d$__$28$mongodb$2c$__cjs$29$__["ObjectId"](invoiceId)
                });
            } catch (e) {
            // ignore
            }
        ...
        const newPaidAmount = paymentHistory.reduce((sum, p)=>sum + Number(p.amount || 0), 0);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__301cecea._.js.map