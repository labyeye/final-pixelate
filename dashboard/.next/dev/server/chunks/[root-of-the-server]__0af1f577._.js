module.exports = [
  ...
  (__turbopack_context__) => {
    ...
    const WA_ERROR_MAP = {
      ...
      132000:
        "Template not found or not approved. Check WHATSAPP_TEMPLATE_NAME.",
      132001:
        "Template parameter count or type does not match the approved template.",
      132005:
        "Template language code is wrong. Set WHATSAPP_TEMPLATE_LANG=en_US.",
      132007:
    ...
    async function POST(req) {
      ...
      try {
        ...
        console.error(
          "[WhatsApp] Network error calling Graph API:",
          networkErr,
        );
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__[
          "NextResponse"
          ...
          {
            error:
              "Network error while contacting WhatsApp API. Please try again.",
          },
          {
            status: 502,
          },
      ...
      if (!waResponse.ok) {
        ...
        const isDocumentError =
          documentErrorCodes.includes(code) ||
