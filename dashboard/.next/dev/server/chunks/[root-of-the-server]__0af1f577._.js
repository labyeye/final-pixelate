...
"[project]/Desktop/Projects/final-pixelate/dashboard/src/app/api/send-invoice-whatsapp/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    if (clientId) {
        try {
            const clientDoc = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["findById"]("clients", clientId);
            if (!clientDoc) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    if (invoiceId) {
        try {
            const invoiceDoc = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["findById"]("invoices", invoiceId);
    ...
    if (invoiceId) {
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateById"]("invoices", invoiceId, {
                whatsapp_sent: true,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0af1f577._.js.map