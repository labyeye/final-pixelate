...
"[project]/Desktop/Projects/final-pixelate/dashboard/src/app/api/whatsapp-optin/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    try {
        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateById"]("clients", clientId, {
        ...
        console.info(`[WhatsApp Opt-In] Client ${clientId} opted in via ${source ?? "invoice_creation"} for invoice ${invoiceNo ?? "N/A"}`);
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: true,
            clientId,
            updated
...
async function DELETE(req) {
    ...
    try {
        ...
        console.info(`[WhatsApp Opt-Out] Client ${clientId} opted out. Reason: ${reason ?? "manual"}`);
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: true,
            clientId
        });
