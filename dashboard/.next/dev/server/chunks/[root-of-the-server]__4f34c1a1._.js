...
"[project]/Desktop/Projects/final-pixelate/dashboard/src/app/api/whatsapp-templates/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const templates = await db.collection(COLLECTION).find(query).sort({
            createdAt: -1
        }).toArray();
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(serialized);
    } catch (err) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4f34c1a1._.js.map