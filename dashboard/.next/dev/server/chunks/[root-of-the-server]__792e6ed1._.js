...
"[project]/Desktop/Projects/final-pixelate/dashboard/src/app/api/applications/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const query = jobId ? {
            jobId: new __TURBOPACK__imported__module__$5b$externals$5d2f$mongodb__$5b$external$5d$__$28$mongodb$2c$__cjs$29$__["ObjectId"](jobId)
        } : {};
        const applications = await db.collection('applications').find(query).sort({
            appliedAt: -1
        }).toArray();
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(applications, {
            headers: corsHeaders
        });
    } catch (error) {
...
async function POST(request) {
    try {
        ...
        const newApplication = {
            ...body,
            jobId: new __TURBOPACK__imported__module__$5b$externals$5d2f$mongodb__$5b$external$5d$__$28$mongodb$2c$__cjs$29$__["ObjectId"](body.jobId),
            status: 'pending',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__792e6ed1._.js.map