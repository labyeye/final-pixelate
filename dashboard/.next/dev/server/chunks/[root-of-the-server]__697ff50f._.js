module.exports = [
  ...
  "[project]/src/app/api/social-media-posts/[id]/route.ts [app-route] (ecmascript)",
  (__turbopack_context__) => {
    "use strict";
    ...
    async function logErpEvent(type, target, details, userId, email) {
      try {
        const response = await fetch(
          `${("TURBOPACK compile-time value", "http://localhost:9002")}/api/erp-events`,
          {
            method: "POST",
            headers: {
        ...
        await logErpEvent(
          ...
          "socialMediaPost",
          {
            ...
            changes: Object.keys(updateData).filter(
              (key) => oldPost[key] !== updateData[key],
            ),
            before: oldPost,
            after: updated,
          },
      ...
      try {
        ...
        if (post.approvalStatus === "Approved") {
          return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__[
            ...
            {
              error:
                "This post has already been approved and cannot be changed.",
            },
            {
              status: 400,
              headers: CORS,
    ...
    async function DELETE(request, { params }) {
      try {
        ...
        const ok =
          await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__[
            "softDeleteById"
          ]("socialMediaPosts", id, "Social Media Post");
        if (!ok) {
          return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__[
            "NextResponse"
          ].json(
