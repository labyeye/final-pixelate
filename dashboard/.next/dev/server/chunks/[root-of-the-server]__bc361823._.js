module.exports = [
  ...
  "[project]/src/lib/bihar-cities.json (json)",
  (__turbopack_context__) => {
    __turbopack_context__.v({
      _comment:
        "Allowlist of Bihar cities/districts. Matching is case-insensitive and whitespace-tolerant (see normalize() in consumers). Add new spellings/variants as you encounter them. Used by dashboard/scripts/delete-non-bihar-kalahanu-leads.js and dashboard/src/app/api/client-leads/sync/route.ts.",
      cities: [
        "Bihar",
        "Araria",
        "Arwal",
  ...
  (__turbopack_context__) => {
    ...
    var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$bihar$2d$cities$2e$json__$28$json$29$__ =
      __turbopack_context__.i("[project]/src/lib/bihar-cities.json (json)");
    ...
    const normalizeCity = (v) =>
      String(v ?? "")
        .trim()
        .toLowerCase();
    const BIHAR_SET = new Set(
      __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$bihar$2d$cities$2e$json__$28$json$29$__[
        "default"
