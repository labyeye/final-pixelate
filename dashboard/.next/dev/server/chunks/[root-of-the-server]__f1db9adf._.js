...
"[project]/Desktop/Projects/final-pixelate/dashboard/src/app/api/campaigns/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function DELETE(request, { params }) {
    try {
        ...
        if (__TURBOPACK__imported__module__$5b$externals$5d2f$mongodb__$5b$external$5d$__$28$mongodb$2c$__cjs$29$__["ObjectId"].isValid(campaignId)) {
            query._id = new __TURBOPACK__imported__module__$5b$externals$5d2f$mongodb__$5b$external$5d$__$28$mongodb$2c$__cjs$29$__["ObjectId"](campaignId);
        } else {
...
async function PUT(request, { params }) {
    try {
        ...
        const result = await db.collection("campaigns").updateOne({
            _id: new __TURBOPACK__imported__module__$5b$externals$5d2f$mongodb__$5b$external$5d$__$28$mongodb$2c$__cjs$29$__["ObjectId"](campaignId)
        }, {
            $set: {
                ...updates,
                updatedAt: new Date()
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f1db9adf._.js.map