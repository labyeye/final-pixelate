...
"[project]/src/app/api/nda-approvals/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    try {
        ...
        const col = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCollection"]("nda_approvals");
        let filter = {};
        if (clientIdParam) {
            try {
                filter = {
...
async function POST(request) {
    ...
    try {
        ...
        const created = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createNdaApproval"](body);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__436c7528._.js.map