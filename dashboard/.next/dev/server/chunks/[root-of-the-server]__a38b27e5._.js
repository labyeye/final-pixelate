...
"[project]/src/app/api/work-gallery/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(_request, { params }) {
    try {
        ...
        const item = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["findById"]('workGallery', id);
...
async function PUT(request, { params }) {
    try {
        ...
        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateById"]('workGallery', id, {
            ...body,
            updatedAt: new Date()
        });
...
async function DELETE(_request, { params }) {
    try {
        ...
        const { verifyToken } = await __turbopack_context__.A("[project]/src/lib/auth.ts [app-route] (ecmascript, async loader)");
        const decoded = verifyToken(token);
        if (!decoded) return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"](JSON.stringify({
            error: 'unauthorized'
        }), {
            status: 401,
            headers: CORS_HEADERS
        });
        if (decoded.role !== 'admin') return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"](JSON.stringify({
            error: 'forbidden'
        }), {
            status: 403,
            headers: CORS_HEADERS
        });
        const deleted = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deleteById"]('workGallery', id);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a38b27e5._.js.map