module.exports = [
  ...
  (__turbopack_context__) => {
    ...
    async function createOnboardingJourneyEvent(
      ...
      await db.collection("journey_events").insertOne({
        ...
        fileUrl: null,
        linkUrl: `/onboarding`,
        occurredAt: onboardingDoc.date
          ? new Date(onboardingDoc.date)
          : new Date(),
        metadata: {
          onboardingId,
  ...
  "[project]/Desktop/Projects/final-pixelate/dashboard/src/app/api/onboarding/[id]/route.ts [app-route] (ecmascript)",
  (__turbopack_context__) => {
    "use strict";
