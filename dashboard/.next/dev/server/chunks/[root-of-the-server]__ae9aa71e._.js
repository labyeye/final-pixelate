...
"[project]/Desktop/Projects/final-pixelate/dashboard/src/app/api/onboarding/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(_request, context) {
    try {
        ...
        const item = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["findById"]("onboardings", id);
        if (!item) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Not found"
            }, {
...
async function PUT(request, context) {
    try {
        ...
        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateById"]("onboardings", id, {
            ...body,
            updatedAt: new Date()
        });
        if (updated?.clientId) {
                ...
                if (existing?._id) {
                    await db.collection("journey_events").updateOne({
                        ...
                        $set: {
                            ...
                            clientName: updated.clientName ?? updated.company ?? existing.clientName ?? "",
                            projectId: updated.projectId ? String(updated.projectId) : null,
                            projectName: updated.projectTitle ?? updated.projectType ?? updated.productType ?? existing.projectName ?? null,
                            title: `Onboarding Completed${updated.projectTitle ? ` – ${updated.projectTitle}` : ""}`,
                            status: "Completed",
                            occurredAt: updated.date ? new Date(updated.date) : existing.occurredAt ?? new Date(),
                            updatedAt: new Date(),
                            metadata: {
                                ...existing.metadata ?? {},
                                onboardingId,
                    ...
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$journey$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createOnboardingJourneyEvent"])(db, onboardingId, updated);
                }
            } catch (journeyErr) {
...
async function DELETE(_request, context) {
    try {
        ...
        const ok = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deleteById"]("onboardings", id);
        if (!ok) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Not found"
            }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ae9aa71e._.js.map