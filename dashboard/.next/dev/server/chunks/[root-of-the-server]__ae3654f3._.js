...
"[project]/Desktop/Projects/final-pixelate/dashboard/src/app/api/support-tickets/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        const { id } = params;
        const col = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCollection"]("supportTickets");
        const hex24 = typeof id === "string" && /^[a-fA-F0-9]{24}$/.test(id);
        const ticket = hex24 ? await col.findOne({
            _id: new __TURBOPACK__imported__module__$5b$externals$5d2f$mongodb__$5b$external$5d$__$28$mongodb$2c$__cjs$29$__["ObjectId"](id)
        }) : await col.findOne({
            id
        });
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(ticket);
    } catch (error) {
...
async function PATCH(request, { params }) {
    try {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(updatedTicket);
    } catch (error) {
...
async function DELETE(request, { params }) {
    try {
        ...
        const col = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCollection"]("supportTickets");
        const hex24 = typeof id === "string" && /^[a-fA-F0-9]{24}$/.test(id);
        const result = hex24 ? await col.deleteOne({
            _id: new __TURBOPACK__imported__module__$5b$externals$5d2f$mongodb__$5b$external$5d$__$28$mongodb$2c$__cjs$29$__["ObjectId"](id)
        }) : await col.deleteOne({
            id
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ae3654f3._.js.map