module.exports = [
  ...
  "[project]/Desktop/Projects/final-pixelate/dashboard/src/app/api/work-gallery/route.ts [app-route] (ecmascript)",
  (__turbopack_context__) => {
    "use strict";
    ...
    async function GET() {
      try {
        ...
        try {
          console.debug(
            "[api/work-gallery] GET items count:",
            Array.isArray(items) ? items.length : 0,
            "sample description:",
            items && items[0] ? items[0].description : null,
            "sample note:",
            items && items[0] ? items[0].note : null,
          );
        } catch (e) {}
