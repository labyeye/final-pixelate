...
"[project]/src/lib/product-sync.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function syncClientSubscription(clientId, status, renewalDate) {
    try {
        const client = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["findById"]("clients", clientId);
        if (!client) return;
        const product = client.product;
        const externalTenantId = client.externalTenantId;
        if (!product || product === "none" || !externalTenantId) return;
        const config = getProductConfig(product);
        if (!config || !config.backendUrl || !config.secret) {
            console.warn(`[product-sync] Skipping ${product} sync for client ${clientId} — backend URL/secret not configured`);
            return;
        }
        ...
        if (!res.ok) {
            ...
            console.error(`[product-sync] ${product} subscription ${status} failed for client ${clientId} (${res.status}): ${text.slice(0, 200)}`);
        }
    } catch (e) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$product$2d$sync$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/product-sync.ts [app-route] (ecmascript)");
;
;
;
;
async function POST(req) {
    const auth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$require$2d$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireAuth"])(req);
    ...
    try {
        ...
        const invoice = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["findById"]("invoices", invoiceId);
        if (!invoice) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const invoicesCol = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCollection"]("invoices");
        ...
        if (newStatus === "PAID" && invoice.clientId) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$product$2d$sync$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["syncClientSubscription"])(String(invoice.clientId), "activate", invoice.renewalDate ?? null);
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            newStatus,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__749d6527._.js.map