module.exports = [
  ...
  "[project]/Desktop/Projects/final-pixelate/dashboard/src/lib/quotation-models.ts [app-route] (ecmascript)",
  (__turbopack_context__) => {
    "use strict";
    ...
    function generateQuotationId(
      lastId,
      prefix = `PXL-${new Date().getFullYear()}-`,
      startNumber = 1,
    ) {
  ...
  "[project]/Desktop/Projects/final-pixelate/dashboard/src/lib/journey-helpers.ts [app-route] (ecmascript)",
  (__turbopack_context__) => {
    "use strict";
    ...
    async function createOnboardingJourneyEvent(
      db,
      onboardingId,
      onboardingDoc,
    ) {
      ...
      await db.collection("journey_events").insertOne({
        ...
        clientName,
        projectId: onboardingDoc.projectId
          ? String(onboardingDoc.projectId)
          : null,
    ...
    async function createProjectJourneyEvent(
      db,
      projectId,
      projectDoc,
      mode = "created",
      ...
      const descriptionParts = [`📁 Project: ${title}`];
  ...
  "[project]/Desktop/Projects/final-pixelate/dashboard/src/lib/require-auth.ts [app-route] (ecmascript)",
  (__turbopack_context__) => {
    "use strict";

    __turbopack_context__.s(["requireAuth", () => requireAuth]);
    ...
    function requireAuth(request) {
      ...
      if (!decoded) {
        return {
          decoded: null,
          error:
            __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__[
              "NextResponse"
            ].json(
              {
                error: "unauthorized",
  ...
  (__turbopack_context__) => {
    ...
    var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$quotation$2d$models$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ =
      __turbopack_context__.i(
        "[project]/Desktop/Projects/final-pixelate/dashboard/src/lib/quotation-models.ts [app-route] (ecmascript)",
      );
    var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ =
    ...
    var __TURBOPACK__imported__module__$5b$externals$5d2f$mongodb__$5b$external$5d$__$28$mongodb$2c$__cjs$29$__ =
      __turbopack_context__.i("[externals]/mongodb [external] (mongodb, cjs)");
    var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$journey$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ =
      __turbopack_context__.i(
        "[project]/Desktop/Projects/final-pixelate/dashboard/src/lib/journey-helpers.ts [app-route] (ecmascript)",
      );
    var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$require$2d$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ =
      __turbopack_context__.i(
        "[project]/Desktop/Projects/final-pixelate/dashboard/src/lib/require-auth.ts [app-route] (ecmascript)",
      );
    async function GET(request) {
      const auth = (0,
      __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$require$2d$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__[
        "requireAuth"
      ])(request);
    ...
    async function POST(request) {
      ...
      try {
        ...
        if (!quotationData.quoteId) {
          ...
          quotationData.quoteId = (0,
          __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$quotation$2d$models$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__[
            "generateQuotationId"
          ])(lastQuote?.quoteId, prefix, startNumber);
        }
        const newQuotation = {
          ...quotationData,
        ...
        if (created && created.clientId && created.status !== "DRAFT") {
          try {
            ...
            await (0,
            __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$journey$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__[
              "createQuotationJourneyEvent"
            ])(db, String(result.insertedId), created);
          } catch (journeyErr) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7bc16e34._.js.map
