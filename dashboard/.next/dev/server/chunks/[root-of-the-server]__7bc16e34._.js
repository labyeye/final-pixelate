...
function generateQuotationId(lastId, prefix = `PXL-${new Date().getFullYear()}-`, startNumber = 1) {
...
async function POST(request) {
    ...
    try {
        ...
        if (!quotationData.quoteId) {
            ...
            const settingsCol = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCollection"]("agencySettings");
            const settings = await settingsCol.findOne({});
            const prefix = settings?.quotationPrefix ?? `PXL-${new Date().getFullYear()}-`;
            const startNumber = settings?.quotationStartNumber ?? 1;
            quotationData.quoteId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$quotation$2d$models$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateQuotationId"])(lastQuote?.quoteId, prefix, startNumber);
        }
        const newQuotation = {
            ...quotationData,
        ...
        if (created && created.clientId && created.status !== "DRAFT") {
            try {
                const db = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getDb"])();
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$final$2d$pixelate$2f$dashboard$2f$src$2f$lib$2f$journey$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createQuotationJourneyEvent"])(db, String(result.insertedId), created);
            } catch (journeyErr) {
