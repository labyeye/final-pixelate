module.exports = [
  ...
  "[project]/src/app/api/payments/[id]/route.ts [app-route] (ecmascript)",
  (__turbopack_context__) => {
    "use strict";

    __turbopack_context__.s(["DELETE", () => DELETE, "PATCH", () => PATCH]);
    ...
    async function DELETE(req, { params }) {
      try {
        ...
        const invoicesCol = await (0,
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__[
          "getCollection"
        ])("invoices");
    ...
    async function PATCH(req, { params }) {
      try {
        const { invoiceId, index, amount, date, mode, remarks } =
          await req.json();
